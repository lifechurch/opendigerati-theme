		...
		<div class="od-homepage">
			<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				...
				<div class="container od-homepage-header">
					<div class="row">
						<div class="col-xs-12 col-md-8 col-lg-7 col-xl-6 center-columns">
			...
			<div class="container od-home-blog-posts">
				<div class="row">
					<div class="col-sm-12 col-md-8 col-lg-12 center-columns">
						<h2 class="od-home-blog-header">Latest Posts</h2>
						...
						<center><button class="od-view-all-button od-view-all-blog-button" ><a href="https://blog.opendigerati.com/">View all blog posts</a></button></center>
					</div>
				</div>
			</div>
